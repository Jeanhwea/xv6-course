...
- 进程管理
  ...
  4) [[file:34-enter-shell.org][从 initcode 到 shell 启动]] | [[https://www.bilibili.com/video/BV1Fw411K7pE/][视频 34]]
- 中断管理
  1) [[file:41-intro-interrupt.org][中断初始化及调用流程]]
  2) [[file:42-exec-syscall.org][系统调用流程分析]]
- 文件系统
